...
class ArtsControllerTest < ActionController::TestCase
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post :create, art: { art_type_id: @art.art_type_id, images: @art.images, name: @art.name, price: @art.price, quantity: @art.quantity, status: @art.status, user_id: @art.user_id }
    end
  ...
  test "should update art" do
    patch :update, id: @art, art: { art_type_id: @art.art_type_id, images: @art.images, name: @art.name, price: @art.price, quantity: @art.quantity, status: @art.status, user_id: @art.user_id }
    assert_redirected_to art_path(assigns(:art))
  end
