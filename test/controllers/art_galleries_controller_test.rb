...
class ArtGalleriesControllerTest < ActionController::TestCase
  ...
  test "should create art_gallery" do
    assert_difference('ArtGallery.count') do
      post :create, art_gallery: { art_id: @art_gallery.art_id, art_type_id: @art_gallery.art_type_id, name: @art_gallery.name, user_id: @art_gallery.user_id }
    end
  ...
  test "should update art_gallery" do
    patch :update, id: @art_gallery, art_gallery: { art_id: @art_gallery.art_id, art_type_id: @art_gallery.art_type_id, name: @art_gallery.name, user_id: @art_gallery.user_id }
    assert_redirected_to art_gallery_path(assigns(:art_gallery))
  end
